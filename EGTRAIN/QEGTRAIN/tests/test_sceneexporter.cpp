...
int main() {
	...
	// 17. Incidents export to the legacy Incidents.txt
	{
		...
		std::ofstream(scene / "infrastructure.json")
			<< R"({"tracks":[{"id":"B0"},{"id":"B1"}],"nodes":[{"id":"n0","track":"B0","x_km":-2,"y_km":0},{"id":"n1","track":"B0","x_km":-1,"y_km":0},{"id":"m0","track":"B1","x_km":0,"y_km":0},{"id":"m1","track":"B1","x_km":1,"y_km":0}],"arcs":[{"id":"a0","track":"B0","from":"n0","to":"n1","curvature_radius_m":0,"gradient_percent":0,"speed_limit_ms":20},{"id":"a1","track":"B1","from":"m0","to":"m1","curvature_radius_m":0,"gradient_percent":0,"speed_limit_ms":20}],"blocks":[{"id":"canonical-block","track":"B0","length_km":1},{"id":"canonical-other","track":"B1","length_km":1}],"connections":[{"id":"switch","from":"n1","to":"m0"}]})"
			<< "\n";
		std::ofstream(scene / "stations.json") << R"({"stations":[{"id":"st","name":"Station","platforms":[]}]})" << "\n";
		std::ofstream(scene / "signalling.json") << R"({"signals":[{"id":"sig-x","protected_section":"@canonical-block@"},{"id":"sig-switch","protected_section":"@canonical-block@--1.000000/@canonical-other@-0.000000"}],"routes":[{"id":"route0","blocks":["canonical-block","@canonical-block@--1.000000/@canonical-other@-0.000000"]}]})" << "\n";
		std::ofstream(scene / "rolling_stock.json")
