...
// class constructor
DispatchDecision::DispatchDecision(std::string messageType, int lineID, std::string stationArr, int arrivalPlatform, int routeID, std::string timetableFile, int intendedDepTime, std::vector<int> dwellTimes)
...
DispatchDecision::DispatchDecision(std::string messageType, int lineID, std::string stationDep, int arrivalPlatform, int routeID, int startTime)
